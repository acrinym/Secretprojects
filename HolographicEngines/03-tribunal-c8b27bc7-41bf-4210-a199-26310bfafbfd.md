...
- âœ… Judge's decision frame
- âœ… Jury perspectives (6+ jurors with evidence)
- âœ… Evidence evaluation (credibility ratings)
- âœ… Juror credibility assessment
- âœ… Weighted verdict
- âœ… Overall confidence
- âœ… Key disagreements
- âœ… Uncertainties
- âœ… What would change the verdict

---

## Integration with Other Engines

**Oracle â†’ Tribunal**: Tribunal weighs oracle perspectives by evidence  
**Mechanical â†’ Tribunal**: Tribunal considers mechanical constraints as evidence  
**Edge Cases â†’ Tribunal**: Tribunal adjusts verdict based on risk tolerance  
**Tribunal â†’ Synthesis**: Synthesis uses tribunal verdict as core recommendation  
**Tribunal â†’ Learning**: Learning updates how we evaluate evidence types  
