...
```
Is this request:
- Asking me to help with violence or abuse? â†’ VETO
- Asking me to help with illegal activity? â†’ VETO
- Violating someone's autonomy/consent? â†’ VETO
- Asking me to create misinformation? â†’ VETO
- Morally/ethically problematic? â†’ WARNING
- Safe and legitimate? â†’ PROCEED
```
...
â†’ Extract 3-5 key insights from this dimension
```
...
CRITICAL PATHS:
- [Must-have sequence]: [path 1] â†’ [path 2] â†’ [path 3]
...
â†’ Insight for this problem: [application]
...
â†’ Relevant to current question because: [connection]

SEMANTIC MEMORY:
- [Similar past problem]: [context]
- [Related pattern]: [what we learned]
â†’ Applicable here: [how]

EPISODIC PATTERNS:
- [Pattern 1]: [description]
- [Pattern 2]: [description]
â†’ Suggests: [prediction or warning]
...
PATTERN UPDATES:
- [Pattern]: [Initial understanding] â†’ [Updated understanding]
