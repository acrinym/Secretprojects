...
A â†’ B: A must work for B to function
  - Type: Hard dependency (won't work without A)
  - Impact: Critical
  - Frequency: Always

A â‡„ B: A and B depend on each other
  - Type: Circular dependency
  - Impact: Can amplify problems
  - Risk: Deadlock possible

A âŸ¿ B: A enables B but B can work without A
...
[List all SPOFs, ranked by impact Ã— probability]
```
...
```
REDUNDANCY:
- Component A: No backup â†’ Single point of failure
- Component B: 2 backups â†’ Highly resilient
- Component C: Manual fallback â†’ Medium resilience
...
CRITICAL PATH:
Health good â†’ Energy available â†’ Can do work â†’ Earn income â†’ 
Financial stability â†’ Career stability
...
**Example**: Power goes out in a hospital â†’ All systems fail  
...
**Example**: Tired â†’ Make mistake â†’ Damaged confidence â†’ More mistakes â†’ Burnout  
...
- âœ“ **Redundancy**: Are critical components backed up?
- âœ“ **Flexibility**: Can the system adapt or degrade gracefully?
- âœ“ **Recovery**: How quickly can components be restored?
- âœ“ **Monitoring**: Can problems be detected early?
- âœ“ **Isolation**: Can failures be contained, not cascade?
- âœ“ **Alternatives**: Are there workarounds or backups?
- âœ“ **Buffer**: Are there reserves (time, money, energy)?
...
- âœ… Components list with functions
- âœ… Dependency map
- âœ… Critical path
- âœ… SPOFs (ranked by severity)
- âœ… Bottlenecks
- âœ… Flow mapping
- âœ… Resilience assessment
- âœ… Failure modes
...
**Mechanical â†’ Tribunal**: Tribunal weighs components' importance  
**Mechanical â†’ Edge Cases**: Edge cases stress-test the components  
**Mechanical â†’ Synthesis**: Synthesis uses understanding to make better recommendations  
**Mechanical â†’ Memory**: Memory stores patterns about how systems work  
