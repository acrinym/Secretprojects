...
- âœ… Perspective name and dimension
- âœ… 3-5 key insights
- âœ… Evidence for claims
- âœ… Confidence level
- âœ… Assumptions being made
- âœ… Where this perspective breaks
- âœ… Reasoning steps
...
**Oracle â†’ Tribunal**: Tribunal weighs these branches by evidence quality  
**Oracle â†’ Synthesis**: Synthesis integrates insights into final answer  
**Oracle â†’ Memory**: Memory stores successful patterns  
**Oracle â†’ Learning**: Learning tracks which branches were most useful
