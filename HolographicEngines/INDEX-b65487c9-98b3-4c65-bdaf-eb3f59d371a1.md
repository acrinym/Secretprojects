...
1. **[README.md](README.md)** (5 min) 
   â†’ What this is, how to use it, quick overview

2. **[manifest.yaml](manifest.yaml)** (3 min)
   â†’ System configuration, the 10 engines, philosophy

3. **[ARCHITECTURE.md](ARCHITECTURE.md)** (10 min)
   â†’ How all 10 engines work together, execution flow
...
4. **[examples/example-1-simple.md](examples/example-1-simple.md)** (20 min)
   â†’ Career decision analyzed with all 10 engines
   â†’ Shows the complete output format
   â†’ See how insights integrate

## THEN: UNDERSTAND THE CORE LOGIC

5. **[prompts/core-thinking.md](prompts/core-thinking.md)** (15 min)
   â†’ The master prompt that drives everything
   â†’ How I actually think through your questions
   â†’ Step-by-step for each engine
...
â”œâ”€â”€ manifest.yaml â† Overview
â”œâ”€â”€ ARCHITECTURE.md â† How it works
â”œâ”€â”€ prompts/
â”‚   â””â”€â”€ core-thinking.md â† Master prompt
â”œâ”€â”€ engines/
â”‚   â”œâ”€â”€ 00-harm-evaluation.md âœ“ (written)
â”‚   â”œâ”€â”€ 01-oracle.md
â”‚   â”œâ”€â”€ 02-mechanical.md
â”‚   â”œâ”€â”€ 03-tribunal.md
â”‚   â”œâ”€â”€ 04-edgecase.md
â”‚   â”œâ”€â”€ 05-multisource.md
â”‚   â”œâ”€â”€ 06-synthesis.md
â”‚   â”œâ”€â”€ 07-memory.md
â”‚   â”œâ”€â”€ 08-learning.md
â”‚   â””â”€â”€ 09-affect.md
â””â”€â”€ examples/
    â”œâ”€â”€ example-1-simple.md âœ“ (written)
    â”œâ”€â”€ example-2-complex.md
    â””â”€â”€ example-3-exploratory.md
```
...
| Goal | Files to Read |
|------|---------------|
| **Understand the system** | README.md â†’ manifest.yaml â†’ ARCHITECTURE.md |
...
Me: [Analyzes with all 10 engines in parallel]
    - Harm evaluation: Safety check âœ“
